function x=istft_multi(X,nsampl,overlapping)
...
for i=1:nchan,
    for j=1:nsrc,
        for t=0:nfram-1,
            ...
            % Overlap-add
            x(j,t*overlapping+1:t*overlapping+wlen,i)=x(j,t*overlapping+1:t*overlapping+wlen,i)+frame.'.*win./swin(t*overlapping+1:t*overlapping+wlen);
        end
    end
end
% Truncation
